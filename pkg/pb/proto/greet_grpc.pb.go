...
func (c *greetingServiceClient) HelloClientStream(ctx context.Context, opts ...grpc.CallOption) (GreetingService_HelloClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetingService_ServiceDesc.Streams[1], "/sample.GreetingService/HelloClientStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greetingServiceClient) HelloBiStreams(ctx context.Context, opts ...grpc.CallOption) (GreetingService_HelloBiStreamsClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetingService_ServiceDesc.Streams[2], "/sample.GreetingService/HelloBiStreams", opts...)
	if err != nil {
		return nil, err
	}
