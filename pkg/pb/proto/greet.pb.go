...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xd2, 0x01, 0x0a, 0x0f, 0x47,
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	1, // 3: sample.GreetingService.Hello:output_type -> sample.HelloResponse
	1, // 4: sample.GreetingService.HellowServerStream:output_type -> sample.HelloResponse
	1, // 5: sample.GreetingService.HelloClientStream:output_type -> sample.HelloResponse
